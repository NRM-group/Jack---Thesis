...
if __name__ == "__main__":
    # X_raw = np.genfromtxt(r'/home/medrobotics/jack_ws/src/movo_scripts/data_20220511.csv', delimiter=',')
    # X_raw = X_raw[:, :3]
    # # remove rows having all zeroes
    # X_raw = X_raw[~np.all(X_raw == 0, axis=1)]
    
    # X_raw = np.delete(X_raw, X_raw[:,2] > 2, axis=0)
    
    # X_filt = filter_outliers(X_raw)
